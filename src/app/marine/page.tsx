  ...
  return (
    <div className="pt-20 sm:pt-24 bg-dark min-h-screen">
      <section className="relative py-16 sm:py-24 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_70%,rgba(200,169,107,0.06),transparent_60%)]" />
              ...
              <motion.div key={vessel.slug} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                <Link href={`/marine/${vessel.slug}`}
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="font-serif text-lg text-white mb-1 group-hover:text-gold transition-colors">{vessel.title}</h3>
